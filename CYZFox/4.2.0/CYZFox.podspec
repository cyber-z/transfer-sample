...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = "https://github.com/forceoperationx/transfer-sample"
  s.license          = {
    :type => "Copyright",
  ...
  s.platform     = :ios, "7.0"
  s.source           = {:http => "https://github.com/forceoperationx/transfer-sample/releases/download/#{s.version}/CYZFox_iOS_static_#{s.version}.zip"}
